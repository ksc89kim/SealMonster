...
ShapeW* ShapeW::create()
{
    ShapeW *pSprite = new ShapeW();
...
void ShapeW::changeImage()
{
    if(isLegend())
    {
        this->setSpriteFrame(Sprite::create("shapeW/l.png")->getSpriteFrame());
...
void ShapeW::setValue()
{
    _shapeData->_type->setShapeValue(bushType::kBushShapeW);
    setName();
    setStatus();
}
const char *ShapeW::getFirstImageName()
{
    Vector<Ref *> *nameArray = ShapeNameContainer::getInstance()->getShapeArray(shapeType::kShapeW);
    for(int i=0;i<nameArray->size();i++)
    {
        ...
        if(!strcmp(name->getFirstName(), _shapeData->_name->getFirstName()))
        {
            ...
            {
                return __String::createWithFormat("shapeW/w1-3-%d.png",i+1)->getCString();
            }
            else if(_shapeData->_class->getShapeValue()==2)
            {
                return __String::createWithFormat("shapeW/w2-3-%d.png",i+1)->getCString();
            }
            else if(_shapeData->_class->getShapeValue()==3)
            {
                return __String::createWithFormat("shapeW/w3-3-%d.png",i+1)->getCString();
            }
            break;
        }
    }
...
const char *ShapeW::getMidImageName()
{
    Vector<Ref *> *nameArray = ShapeNameContainer::getInstance()->getShapeArray(shapeType::kShapeW);
    for(int i=0;i<nameArray->size();i++)
    {
        ...
        if(!strcmp(name->getMidName(), _shapeData->_name->getMidName()))
        {
            if(_shapeData->_class->getShapeValue()==1)
            {
                return __String::createWithFormat("shapeW/w1-2-%d.png",i+1)->getCString();
            }
            else if(_shapeData->_class->getShapeValue()==2)
            {
                return __String::createWithFormat("shapeW/w2-2-%d.png",i+1)->getCString();
            }
            else if(_shapeData->_class->getShapeValue()==3)
            {
                return __String::createWithFormat("shapeW/w3-2-%d.png",i+1)->getCString();
            }            break;
        }
    }
    return "";
}
const char *ShapeW::getLastImageName()
{
    Vector<Ref *> *nameArray = ShapeNameContainer::getInstance()->getShapeArray(shapeType::kShapeW);
    for(int i=0;i<nameArray->size();i++)
    {
        ...
        if(!strcmp(name->getLastName(), _shapeData->_name->getLastName()))
        {
            if(_shapeData->_class->getShapeValue()==1)
            {
                return __String::createWithFormat("shapeW/w1-1-%d.png",i+1)->getCString();
            }
            else if(_shapeData->_class->getShapeValue()==2)
            {
                return __String::createWithFormat("shapeW/w2-1-%d.png",i+1)->getCString();
            }
            else if(_shapeData->_class->getShapeValue()==3)
            {
                return __String::createWithFormat("shapeW/w3-1-%d.png",i+1)->getCString();
            }            break;
        }
    }
...
void ShapeW::setName()
{
    ...
    if(isLegend())
    {
        ...
        TextDb::getInstance()->runQueryShapeName(991, lengend);
    ...
    {
        firstName = ShapeNameContainer::getInstance()->getRandShapeName(shapeType::kShapeW);
        midName = ShapeNameContainer::getInstance()->getRandShapeName(shapeType::kShapeW);
        lastName = ShapeNameContainer::getInstance()->getRandShapeName(shapeType::kShapeW);
        setNameAndClassNumber(firstName,midName,lastName);
    }
    
}
void ShapeW::changeRandShape(int minRandLevel, int maxRandLeve)
{
...
void ShapeW::changeFindShape(int firstIndex,int midIndex, int lastIndex)
{
...
void ShapeW::setStatus()
{
    if(isLegend())
    {
        _shapeData->_class->setShapeValue(3.0f);
        Vector<Ref *> *skillArray = ShapeSkillContainer::getInstance()->getShapeArray(shapeType::kShapeW);
...
ShapeObject *ShapeW::getStatusObject(int index)
{
    ...
    switch (index) {
        ...
        case 0:
            ...
            statusObject->_agility->setShapeValue(14);
            break;
        case 1:
        ...
        case 2:
            ...
            statusObject->_agility->setShapeValue(10);
            break;
        case 3:
        ...
        case 7:
            ...
            break;
        case 8:
            statusObject->_power->setShapeValue(4);
            statusObject->_agility->setShapeValue(7);
            break;
        case 9:
            statusObject->_power->setShapeValue(5);
