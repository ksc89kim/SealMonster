...
@property (nonatomic, unsafe_unretained) id <GameCenterMultiplayerManagerDelegate> multiplayerDelegate;
...
/** Sends data to \b all players in the current multiplayer match using the specified parameters
 ...
 @discussion Use this method to se```+**nd data to all players in a match. If you do not need to send data to all players, instead use the alternate method which lets you specify players.
